...
```{r, echo = FALSE, fig.align = "center", fig.height = h * 1, fig.width = w * 3}
# load feature data
...
p1 <- problem(sim_pu_polygons, sim_features,
              cost_column = sim_pu_polygons$cost)
# lines
p2 <- problem(sim_pu_lines, sim_features, cost_column = sim_pu_lines$cost)

# points
p3 <- problem(sim_pu_points, sim_features, cost_column = sim_pu_points$cost)
```
...
p.r2 <- p4 %>%
        add_relative_targets(c(0.5, 0.1, 0.1, 0.1, 0.1))
```
...
```{r, echo = FALSE, fig.height = h * 1, fig.width = w * 2, fig.align = "center"}
# load feature data
...
```{r, echo = FALSE, eval = FALSE, fig.height = h * 1, fig.width = w * 3, fig.align = "center"}
...
```{r, results = "hide", message = FALSE, fig.align = "center", fig.height = h, fig.width = w}
...
```{r, results = "hide", fig.align = "center", fig.height = h * 0.7}
