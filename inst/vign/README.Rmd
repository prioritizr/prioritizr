...
cat(paste0("Hanson JO, Schuster R, Morrell N, Strimas-Mackey M, Watts ME, Arcese P, Bennett J, Possingham HP (2017). prioritizr: Systematic Conservation Prioritization in R. R package version ",packageDescription("prioritizr")$Version,".\nhttps://github.com/prioritizr/prioritizr.\n"))
```
