...
```{r, eval = TRUE, results='hide', message=FALSE, fig.align='center', fig.height = h, fig.width = w}
...
Marxan input files can also be read into the function individually. The system files available in _prioritizr_ currently throw an error, so the following code is purely provided as an example.
...
```{r eval=TRUE, results='hide', fig.align='center', fig.height = h * 0.7}
