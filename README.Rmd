...
Please refer to the [package website](https://prioritizr.github.io/prioritizr/index.html) for more information on the _prioritizr R_ package. This website contains a [tutorial on systematic conservation planning and using the package](https://prioritizr.github.io/prioritizr/articles/prioritizr.html), [instructions for installing the _Gurobi_ software suite to solve large-scale and complex conservation planning problems](https://prioritizr.github.io/prioritizr/articles/gurobi_installation.html), and a [tutorial on building and solving problems that contain multiple management zones](https://prioritizr.github.io/prioritizr/articles/zones.html). If you have any questions about using the the _prioritizr R_ package or suggestions from improving it, please [file an issue at the package's online code repository](https://github.com/prioritizr/prioritizr/issues/new).
