...
> Hanson JO, Schuster R, Morrell N, Strimas-Mackey M, Edwards BPM, Watts
> ME, Arcese P, Bennett J, Possingham HP (2022). prioritizr: Systematic
> Conservation Prioritization in R. R package version 7.2.0.9. Available
...
```
    ...
    ##  55350 30014 2676.57525   65    2 2747.37746 2621.61502  4.58%   1.6    5s
    ## H128246  6692                    2627.6389306 2623.20411  0.17%   1.5    8s
    ## 
    ## Cutting planes:
    ##   Gomory: 2
    ##   MIR: 6
    ...
    ##   Flow cover: 1
    ## 
    ## Explored 145469 nodes (243327 simplex iterations) in 9.89 seconds (2.59 work units)
...
```
    ...
    ##   Flow cover: 1
    ## 
    ## Explored 10262 nodes (23307 simplex iterations) in 1.49 seconds (0.54 work units)
    ## Thread count was 1 (of 8 available processors)
    ## 
...
```
    ...
    ##   Zero half: 1
    ## 
    ## Explored 1 nodes (221 simplex iterations) in 0.07 seconds (0.02 work units)
    ## Thread count was 1 (of 8 available processors)
    ## 
