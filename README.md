...
the relative abundance of individuals, with higher values indicating a
greater abundance.
...
following *R* code. Although the HiGHS solver is relatively fast, please
note that you’ll want to install the [Gurobi software suite and the
*gurobi* *R* package](https://www.gurobi.com/) if you need best
performance (see the [Gurobi Installation
...
```
    ...
    ##        0    2.8348868e+02   5.900880e+05   0.000000e+00      8s
    ##      304    1.3493756e+04   0.000000e+00   0.000000e+00      8s
    ...
    ## 
    ## Explored 1 nodes (304 simplex iterations) in 8.77 seconds (9.14 work units)
...
```
    ...
    ## 
    ## 
    ## Root relaxation: objective 3.061712e+04, 107 iterations, 0.09 seconds (0.18 work units)
    ## 
    ##     Nodes    |    Current Node    |     Objective Bounds      |     Work
    ##  Expl Unexpl |  Obj  Depth IntInf | Incumbent    BestBd   Gap | It/Node Time
    ## 
    ##      0     0 30617.1194    0   23 38666.1948 30617.1194  20.8%     -    2s
    ## H    0     0                    31972.957002 30617.1194  4.24%     -    2s
    ## 
    ## Explored 1 nodes (107 simplex iterations) in 2.29 seconds (2.74 work units)
    ## Thread count was 1 (of 8 available processors)
    ## 
...
```
    ...
    ## 
    ## 
    ## Root relaxation: objective 1.466646e+05, 4591 iterations, 0.36 seconds (0.63 work units)
    ## 
    ##     Nodes    |    Current Node    |     Objective Bounds      |     Work
    ##  Expl Unexpl |  Obj  Depth IntInf | Incumbent    BestBd   Gap | It/Node Time
    ## 
    ##      0     0 146664.650    0   44 157859.675 146664.650  7.09%     -    3s
    ## 
    ## Explored 1 nodes (4591 simplex iterations) in 3.05 seconds (5.70 work units)
    ## Thread count was 1 (of 8 available processors)
    ## 
...
<img src="man/figures/README-replacement_cost-1.png" width="500" style="display: block; margin: auto;" />
