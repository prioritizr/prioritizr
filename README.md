...
This package largely consists of five main types of functions. These functions are used to:
...
```
Hanson JO, Schuster R, Strimas-Mackey M, Arcese P, Bennett J (2017). prioritizr: Systematic Conservation Prioritization in R. R package version 1.0.0. https://github.com/prioritizr/prioritizr.
```
...
![plot of chunk unnamed-chunk-4](inst/vign/readme-figure/unnamed-chunk-4-2.png)
