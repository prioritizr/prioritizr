...
```
    ...
    ## 
    ##      0     0 13493.7559    0   46 24763.9276 13493.7559  45.5%     -    7s
    ## H    0     0                    15821.627271 13493.7559  14.7%     -    7s
    ## H    0     0                    14441.536489 13493.7559  6.56%     -    7s
    ## 
    ## Explored 1 nodes (304 simplex iterations) in 8.00 seconds (9.14 work units)
...
```
    ...
    ## 
    ## 
    ## Root relaxation: objective 1.466646e+05, 4591 iterations, 0.26 seconds (0.63 work units)
    ## 
    ##     Nodes    |    Current Node    |     Objective Bounds      |     Work
    ##  Expl Unexpl |  Obj  Depth IntInf | Incumbent    BestBd   Gap | It/Node Time
    ## 
    ...
    ## 
    ## Explored 1 nodes (4591 simplex iterations) in 2.35 seconds (5.70 work units)
    ## Thread count was 1 (of 8 available processors)
    ## 
