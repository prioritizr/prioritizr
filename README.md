...
> Hanson JO, Schuster R, Morrell N, Strimas-Mackey M, Edwards BPM, Watts
> ME, Arcese P, Bennett J, Possingham HP (2022). prioritizr: Systematic
> Conservation Prioritization in R. R package version 7.2.1.1. Available
...
```
    ...
    ##  30702 13664 2645.80660   48    1 2747.37746 2620.26127  4.63%   1.6    5s
    ...
    ##   Flow cover: 3
    ## 
    ## Explored 108086 nodes (186594 simplex iterations) in 9.53 seconds (2.28 work units)
