...
--------
    ...
    Hanson JO, Schuster R, Morrell N, Strimas-Mackey M, Watts ME, Arcese P, Bennett J, Possingham HP (2017). prioritizr: Systematic Conservation Prioritization in R. R package version 1.0.2.0. https://github.com/prioritizr/prioritizr.
...
```
    ...
    ## 
    ## 
    ## Root relaxation: objective 5.477092e+03, 245 iterations, 0.01 seconds
    ## 
    ##     Nodes    |    Current Node    |     Objective Bounds      |     Work
    ##  Expl Unexpl |  Obj  Depth IntInf | Incumbent    BestBd   Gap | It/Node Time
    ## 
    ...
    ##   Gomory: 1
    ## 
    ## Explored 0 nodes (278 simplex iterations) in 0.21 seconds
    ## Thread count was 1 (of 4 available processors)
    ## 
...
```
    ...
    ## 
    ## 
    ## Root relaxation: objective 5.647064e+03, 519 iterations, 0.03 seconds
    ## 
    ##     Nodes    |    Current Node    |     Objective Bounds      |     Work
    ##  Expl Unexpl |  Obj  Depth IntInf | Incumbent    BestBd   Gap | It/Node Time
    ## 
    ...
    ##   Zero half: 23
    ## 
    ## Explored 67 nodes (1856 simplex iterations) in 0.79 seconds
    ## Thread count was 1 (of 4 available processors)
    ## 
