...
> Hanson JO, Schuster R, Morrell N, Strimas-Mackey M, Watts ME, Arcese P, Bennett J, Possingham HP (2020). prioritizr: Systematic Conservation Prioritization in R. R package version 5.0.2.2. Available at <https://github.com/prioritizr/prioritizr>.
...
```
    ...
    ##   Flow cover: 2
    ## 
    ## Explored 31196 nodes (83170 simplex iterations) in 3.04 seconds
