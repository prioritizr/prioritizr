...
> Hanson JO, Schuster R, Morrell N, Strimas-Mackey M, Watts ME, Arcese P, Bennett J, Possingham HP (2021). prioritizr: Systematic Conservation Prioritization in R. R package version 7.0.0.6. Available at <https://github.com/prioritizr/prioritizr>.
...
```
    ...
    ##  74359 42219 2628.29358   44    1 2747.37746 2621.73732  4.57%   1.7    5s
    ...
    ##   Flow cover: 10
    ## 
    ## Explored 99210 nodes (201659 simplex iterations) in 7.24 seconds
