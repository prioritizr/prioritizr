...
```
    ...
    ##   Flow cover: 1
    ## 
    ## Explored 145469 nodes (243327 simplex iterations) in 3.96 seconds (2.59 work units)
...
```
    ...
    ##   Flow cover: 1
    ## 
    ## Explored 10262 nodes (23307 simplex iterations) in 0.59 seconds (0.54 work units)
    ## Thread count was 1 (of 8 available processors)
    ## 
