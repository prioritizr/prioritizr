...
--------
    ...
    Hanson JO, Schuster R, Morrell N, Strimas-Mackey M, Watts ME, Arcese P, Bennett J, Possingham HP (2017). prioritizr: Systematic Conservation Prioritization in R. R package version 2.0.0.0. https://github.com/prioritizr/prioritizr.
...
```
    ...
    ##   Zero half: 23
    ## 
    ## Explored 67 nodes (1856 simplex iterations) in 0.15 seconds
    ## Thread count was 1 (of 4 available processors)
    ## 
