...
#' \describe{
#'
#'   \item{\code{add_default_decisions}}{This decision represents the default
...
#'
#'   \item{\code{add_binary_decisions}}{This is the classic decision of either
...
#'
#'   \item{\code{add_proportion_decisions}}{This is a relaxed decision where
#'     a part of a planning unit can be prioritized. Typically, this
#'     this decision has the assumed action of buying a fraction of
#'     a planning unit to include in a protected area network.}
#'
#'   \item{\code{add_semicontinuous_decisions}}{This decision is similar to the
