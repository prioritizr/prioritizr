...
#'   \describe{
#'
#'   \item{statistic}{`character` description of the statistic.
...
#' }
#' @export
eval_n <- function(x, solution) UseMethod("eval_n")

#' @rdname eval_n
#' @method eval_n default
#' @export
eval_n.default <- function(x, solution) {
  stop("argument to x must be a ConservationProblem object")
}

#' @rdname eval_n
#' @method eval_n ConservationProblem
#' @export
eval_n.ConservationProblem <- function(x, solution) {
  ...
  if (x$number_of_zones() > 1) {
    ...
    out <- tibble::tibble(statistic = "overall", cost = total_n)
  }
  # return result
  out
}
