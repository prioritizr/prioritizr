...
#' error message when solving. The following objectives can be applied to a 
#' conservation planning problem. 
#'
#'
#' \describe{
#'
#'   \item{\code{add_min_set_objective}}{Set an objective to find the 
...
#'
#'   \item{\code{add_max_cover_objective}}{Set an objective to find the 
#'   solution that secures as much of each feature as possible without 
#'   exceeding the budget.}
#'
#'   \item{\code{add_max_features_objective}}{Set an objective to find to find 
...
#'
#'   \item{\code{add_max_phylo_objective}}{Set an objective to find to find the 
