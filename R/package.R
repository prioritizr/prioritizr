...
#' \href{https://github.com/prioritizr/prioritizr}{online code repository} for
#' more details.
#'
#' @details
...
#' \describe{
#'
#'\item{\href{https://prioritizr.github.io/prioritizr/articles/prioritizr_basics.html}{Prioritizr Basics}}{Provides background information on the concepts and
#'terminology of systematic conservation prioritization underlying the
#' functions in this package.}
#'
#'\item{\href{https://prioritizr.github.io/prioritizr/articles/quick_start.html}{Quickstart Guide}}{Provides a walk-through of the functions available in the
#' prioritizr package and their usage with a simulated dataset. Users should be
#' familiar with the basic terminology of systematic conservation
#' prioritization.}
#'
#' }
#'
