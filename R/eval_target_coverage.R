...
#' }
#'
#' @name eval_target_coverage
#'
#' @aliases eval_target_coverage,ConservationProblem,numeric-method eval_target_coverage,ConservationProblem,matrix-method eval_target_coverage,ConservationProblem,data.frame-method eval_target_coverage,ConservationProblem,Spatial-method eval_target_coverage,ConservationProblem,sf-method eval_target_coverage,ConservationProblem,Raster-method
#'
...
#'
#' # calculate target coverage by the solution
#' r2 <- eval_target_coverage(p2, s2[, "solution_1"])
#' print(r2, width = Inf)
#'
...
#'
#' # calculate target coverage by the solution
#' r3 <- eval_target_coverage(p3, s3[, c("solution_1_zone_1",
#'                                       "solution_1_zone_2",
#'                                       "solution_1_zone_3")])
#' print(r3, width = Inf)
#'
...
#' }
#' @export
eval_target_coverage <- function(x, solution, include_zone, include_sense)
  UseMethod("eval_target_coverage")

#' @rdname eval_target_coverage
#' @method eval_target_coverage default
#' @export
eval_target_coverage.default <- function(
  x, solution, include_zone, include_sense) {
  stop("argument to x must be a ConservationProblem object")
}

#' @rdname eval_target_coverage
#' @method eval_target_coverage ConservationProblem
#' @export
eval_target_coverage.ConservationProblem <- function(
  x, solution,
  ...
  cn <- c(
    "feature", "zone", "sense", "total_amount",
