...
#' (2002). It also requires the \emph{ape} package to be installed.
#'
...
#'   Maximize sum_i^I (-s * ci) + sum_j^J (mb * lb) subject to sum_i^I (xi *
#'   rij) >= (yj * tj) for all j in J & mb <= yj for all j in T(b) & sum_i^I
#'   (xi * ci) <= B}
#'
