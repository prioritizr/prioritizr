...
Lets have a look at the parameters that were used in the benchmark scenarios. If you want to have a look at the benchmarking code and analysis, you can find the GitHub repository here: [benchmark repo](https://github.com/prioritizr/benchmark).
