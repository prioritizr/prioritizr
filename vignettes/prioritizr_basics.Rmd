...
![Figure 1. Example feature distributions on a raster grid of 100x100 planning units, from simulated spatially auto-correlated random fields](prioritizr-figure/simulated_spp_dist.png)
...
![Figure 2. Simulated example of a cost distribution on a raster grid of 100x100 planning units](prioritizr-figure/simulated_cost.png)
