...
The aim of this tutorial is to showcase the zones functionality of the _prioritizr R_ package. It will assume a certain level of familiarity with conservation planning terminology and the _prioritizr R_ package. If you don't have much experience in either of these topics, we recommend fist reading the [_Package overview_](package_overview.html) vignette.
