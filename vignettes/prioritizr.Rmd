...
open-source mixed integer programming solver that is also part of the COIN-OR project. It requires the _rcbc R_ package, which is currently only available on [GitHub](https://github.com/dirkschumacher/rcbc).
```{r}
