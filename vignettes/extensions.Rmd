...
* [_robust.prioritizr_](https://frankiecho.github.io/robust.prioritizr/) provides objectives and constraints to generate prioritizations that account of uncertainty in the expected outcome associated with implementing conservation actions. For example, it can be used to account for uncertainty in climate change scenario projections, species distribution models, ecosystem service models, and measurement errors when identifying priorities for protected area establishment. It uses robust optimization techniques based on the chance constrained programming problems and the conditional value-at-risk problems [@r76; @r77].
