...
#> Error in eval_asym_connectivity_summary(p1, s1[, "solution_1"], data = acm1): ℹ In argument to `solution`.
#> Caused by error:
#> ! object 's1' not found
print(r1)
...
#> Error in eval_asym_connectivity_summary(p2, s2[, c("solution_1_zone_1",     "solution_1_zone_2", "solution_1_zone_3")], data = acm2): ℹ In argument to `solution`.
#> Caused by error:
#> ! object 's2' not found
print(r2)
