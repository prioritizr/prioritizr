...
#> Error in eval_rank_importance(p1, s1, n = 10): ℹ In argument to `solution`.
#> Caused by error:
#> ! object 's1' not found

# print importance scores
print(rs1)
#> Error: object 'rs1' not found

# plot importance scores
plot(rs1, main = "rank importance (10, min shortfall obj", axes = FALSE)
#> Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'plot': object 'rs1' not found
...
#> Error in eval_rank_importance(p1, s1, n = 10, objective = "add_max_utility_objective"): ℹ In argument to `solution`.
#> Caused by error:
#> ! object 's1' not found

# print importance scores
print(rs2)
#> Error: object 'rs2' not found

# plot importance scores
plot(rs2, main = "rank importance (10, max utility obj)", axes = FALSE)
#> Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'plot': object 'rs2' not found
...
#> Error in eval_rank_importance(p1, s1, budgets = budgets): ℹ In argument to `solution`.
#> Caused by error:
#> ! object 's1' not found

# print importance scores
print(rs3)
#> Error: object 'rs3' not found

# plot importance scores
plot(rs3, main = "rank importance (manual)", axes = FALSE)
#> Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'plot': object 'rs3' not found
...
#> Error in eval_rank_importance(p4, s4, n = 5): ℹ In argument to `solution`.
#> Caused by error:
#> ! object 's4' not found
names(rs4) <- paste0("zone ", seq_len(terra::nlyr(sim_zones_pu_raster)))
#> Error: object 'rs4' not found

# plot importance
# each panel corresponds to a different zone, and data show the
# importance of each planning unit in a given zone
plot(rs4, axes = FALSE)
#> Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'plot': object 'rs4' not found
# }
```
