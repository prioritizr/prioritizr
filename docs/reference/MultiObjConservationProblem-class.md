...
- [`MultiObjConservationProblem$new()`](#method-MultiObjConservationProblem-new)
...
### Method [`number_of_problems()`](https://prioritizr.net/reference/number_of_problems.md)
...
### Method [`problem_names()`](https://prioritizr.net/reference/problem_names.md)
