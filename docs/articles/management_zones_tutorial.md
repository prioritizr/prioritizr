...
```
    ...
    ## H    0     0                    11132.000000 10054.0986  9.68%     -    0s
    ## 
    ## Explored 1 nodes (802 simplex iterations) in 0.03 seconds (0.04 work units)
    ## Thread count was 1 (of 8 available processors)
    ## 
    ## Solution count 4: 11132 11300 11408 20096 
    ## 
    ## Optimal solution found (tolerance 1.00e-01)
    ## Best objective 1.113200000000e+04, best bound 1.005600000000e+04, gap 9.6658%
...
```
    ...
    ##  2 overall    feature_2        43.7           8.33         0.191
    ##  3 overall    feature_3       101.           18.9          0.188
    ##  4 overall    feature_4        59.7          11.8          0.198
    ...
    ##  9 few traps  feature_4         4.27          0            0    
    ## 10 few traps  feature_5         5.67          0            0    
    ## 11 many traps feature_1        41.6           8.97         0.215
    ## 12 many traps feature_2        15.6           3.71         0.238
    ## 13 many traps feature_3        36.0           7.23         0.201
    ## 14 many traps feature_4        21.3           5.79         0.271
    ## 15 many traps feature_5        28.4           6.22         0.219
    ## 16 baiting    feature_1        66.6          14.4          0.217
    ## 17 baiting    feature_2        25.0           4.62         0.185
    ## 18 baiting    feature_3        57.6          11.7          0.203
    ## 19 baiting    feature_4        34.1           6.05         0.177
...
```
    ...
    ## Presolve time: 0.01s
    ## Presolved: 785 rows, 876 columns, 2450 nonzeros
    ## Variable types: 0 continuous, 876 integer (876 binary)
    ## Root relaxation presolved: 785 rows, 876 columns, 2450 nonzeros
    ## 
    ## 
    ## Root relaxation: objective 1.323093e+04, 306 iterations, 0.00 seconds (0.00 work units)
    ## 
    ##     Nodes    |    Current Node    |     Objective Bounds      |     Work
    ##  Expl Unexpl |  Obj  Depth IntInf | Incumbent    BestBd   Gap | It/Node Time
    ## 
    ...
    ## 
    ## Explored 1 nodes (471 simplex iterations) in 0.02 seconds (0.03 work units)
    ## Thread count was 1 (of 8 available processors)
    ## 
