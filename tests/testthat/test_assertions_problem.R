...
test_that("assert_pass_presolve_check (list, TRUE)", {
  ...
  # run tests
  expect_silent(expect_true(assert_pass_presolve_check(list(o1, o2))))
})
...
test_that("assert_pass_presolve_check (list, error)", {
  ...
  # run tests
  expect_message(
    expect_error(assert_pass_presolve_check(list(o1, o2))),
    "rij"
  )
})
...
test_that("verify_pass_presolve_check (list, TRUE)", {
  ...
  # run tests
  expect_silent(expect_true(verify_pass_presolve_check(list(o1, o2))))
})
...
test_that("verify_pass_presolve_check (list, warning)", {
  ...
  expect_message(
    expect_warning(
      verify_pass_presolve_check(list(o1, o2))
    ),
    "rij"
  )
})
