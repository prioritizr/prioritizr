...
test_that("works", {
  ...
  pts_geom <- sf::st_as_sf(st_sfc(list(p1)))
  lns_geom <- sf::st_as_sf(st_sfc(list(ls1)))
  ply_geom <- sf::st_as_sf(st_sfc(list(pl1)))
  mply_geom <- sf::st_as_sf(st_sfc(list(mpl1)))
  all_geom  <- sf::st_as_sf(st_sfc(list(p1, mp1, ls1, ml1, pl1, mpl1, gc1)))
  # tests
